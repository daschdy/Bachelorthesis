...
Als Suchstrings wurden Kombinationen aus den Begriffen \textit{\enqquote{computer architecture}}, \textit{\enqquote{education}}, \textit{\enqquote{simulator}}, \textit{\enqquote{teaching}}, \textit{\enqquote{Rechnerarchitektur}} und \textit{\enqquote{Lehre}} verwendet.
...
Unter dem Kriterium \textit{Abstraktion} wird der Grad der didaktischen Vereinfachung verstanden. Simulatoren mit einer stark reduzierten Darstellung wurden mit \enquote{1} codiert, realitätsnahe Abbildungen hingegen mit \enquote{0}. 
...
\sh{Kriterien Tab.~\ref{tab:simulatoren}}
