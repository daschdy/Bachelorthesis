...
\subsection{Web~2.0 und E-Learning}
...
\subsection{MOOCs und M-Learning}
...
\subsection{Gamification und Künstiliche Intelligenz}

2015–2018: Microlearning & Gamification
Microlearning: kurze, modularisierte Lerneinheiten (z. B. über Apps, Push-Nachrichten).
Gamification und Serious Games verbreiten sich – Motivation durch Punkte, Abzeichen, Ranglisten.
Adaptive Learning Systeme passen Inhalte automatisch an den Lernenden an.

2018–2020: Künstliche Intelligenz & Personalisierung
KI im E-Learning: Chatbots als Tutoren, automatische Feedbacksysteme, Empfehlungssysteme.
VR/AR/MR (Virtual, Augmented, Mixed Reality) finden Eingang in Training & Bildung (z. B. Medizin, Technik, Simulation).
Blended Learning 2.0: klassische Präsenzkurse mit hybriden, digitalen Komponenten.

2020–2022: Pandemie & Remote Learning
COVID-19 als Beschleuniger → weltweite Umstellung auf Distance Learning.
Starker Ausbau von Videokonferenz-Plattformen (Zoom, Teams) in Schule, Hochschule und Weiterbildung.
Digitale Didaktik rückt ins Zentrum: Fokus auf Interaktivität, soziale Nähe trotz Distanz.

2022–heute: KI-gestütztes Lernen & Learning Experience
Generative KI (ChatGPT, DALL·E, Claude etc.) revolutioniert Content-Erstellung & Tutorensysteme.
Fokus auf Learning Experience Platforms (LXP): personalisierte Lernumgebungen mit KI-Kuratierten Inhalten.
Learning Analytics 2.0: prädiktive Systeme zur Identifikation von Lernproblemen.
Immersives Lernen: Fortschritte in VR/AR – Metaverse-Konzepte für Bildung werden erprobt.
Microcredentials & digitale Zertifikate gewinnen an Bedeutung im lebenslangen Lernen.
